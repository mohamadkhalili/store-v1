        ...
        <v-card height="400px">
          <v-row style="height: 25% !important;" no-gutters>
            ...
            <v-col cols="6" class="align-center align-self-center">
              ...
              >
                <template v-slot:activator="{ on, attrs }">
                  <info-with-title title="شماره تلفن همراه:" :value="phone" :click="phoneDialogClick"
                                   direction="rtl"/>
                </template>
          ...
          <v-row style="height: 25% !important;" no-gutters>
            ...
            <v-col cols="6" class="align-center align-self-center">
              ...
              >
                <template v-slot:activator="{ on, attrs }">
                  <info-with-title title="کد ملی:" :value="national_code" :click="nationalCodeDialogClick"
                                   direction="rtl"/>
                </template>
          ...
          <v-row style="height: 25% !important;" no-gutters>
            <v-col cols="6" class="align-center align-self-center">
              ...
              >
                <template v-slot:activator="{ on, attrs }">
                  <info-with-title title="کد پستی:" :value="postal_code" :click="postalCodeDialogClick"
                                   direction="rtl"/>
                </template>
          ...
          <v-row style="height: 25% !important;" no-gutters>
            <v-col cols="12" class="align-center align-self-center">
              ...
              >
                <template v-slot:activator="{ on, attrs }">
                  <info-with-title title="آدرس:" :value="address" :click="addressCodeDialogClick"
                                   direction="rtl"/>
                </template>
